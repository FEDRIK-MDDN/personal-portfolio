      ...
      <div className="hero-content">
        ...
        <div className="hero-text">
          ...
          <p className="hero-desc">
            A passionate university student dedicated to building intelligent,
            modern, and aesthetic digital experiences. I love turning ideas into
          ...
          <div className="hero-socials">
            ...
            <a
              id="hero-email-link"
              href="mailto:mailtonimnath@gmail.com"
              className="hero-social-link"
              aria-label="Email"
              title="Email"
            >
